...
function deepmerge(target, source, options = {
  ...
  const output = options.clone ? _extends4({}, target) : target;
...
function breakpoints(styleFunction) {
  const newStyleFunction = (props) => {
    ...
    const extended = themeBreakpoints.keys.reduce((acc, key) => {
      if (props[key]) {
        acc = acc || {};
        acc[themeBreakpoints.up(key)] = styleFunction(_extends3({
          theme
        }, props[key]));
      }
      return acc;
  ...
  newStyleFunction.propTypes = true ? _extends3({}, styleFunction.propTypes, {
...
function processStyleArg(callableStyle, _ref) {
  ...
  const resolvedStylesArg = typeof callableStyle === "function" ? callableStyle(_extends3({
    ownerState
  }, props)) : callableStyle;
  if (Array.isArray(resolvedStylesArg)) {
    return resolvedStylesArg.flatMap((resolvedStyle) => processStyleArg(resolvedStyle, _extends3({
      ownerState
    }, props)));
  }
  if (!!resolvedStylesArg && typeof resolvedStylesArg === "object" && Array.isArray(resolvedStylesArg.variants)) {
    ...
    variants.forEach((variant) => {
      ...
      if (typeof variant.props === "function") {
        isMatch = variant.props(_extends3({
          ownerState
        }, props, ownerState));
      } else {
      ...
      if (isMatch) {
        ...
        result.push(typeof variant.style === "function" ? variant.style(_extends3({
          ownerState
  ...
  return (tag, inputOptions = {}) => {
    ...
    const transformStyleArg = (stylesArg) => {
      if (typeof stylesArg === "function" && stylesArg.__emotion_real !== stylesArg || isPlainObject(stylesArg)) {
        return (props) => processStyleArg(stylesArg, _extends3({}, props, {
          theme: resolveTheme({
            theme: props.theme,
            defaultTheme: defaultTheme4,
            themeId
      ...
      if (componentName && overridesResolver) {
        expressionsWithDefaultTheme.push((props) => {
          ...
          Object.entries(styleOverrides).forEach(([slotKey, slotStyle]) => {
            resolvedStyleOverrides[slotKey] = processStyleArg(slotStyle, _extends3({}, props, {
              theme
            }));
          });
...
function requirePropFactory(componentNameInError, Component) {
  ...
  const prevPropTypes = Component ? _extends4({}, Component.propTypes) : null;
...
function RtlProvider(_ref) {
  ...
  return (0, import_jsx_runtime6.jsx)(RtlContext.Provider, _extends3({
...
// ../../../node_modules/@mui/system/node_modules/@babel/runtime/helpers/esm/typeof.js
function _typeof(o) {
...
// ../../../node_modules/@mui/system/node_modules/@babel/runtime/helpers/esm/toPrimitive.js
...
// ../../../node_modules/@mui/system/node_modules/@babel/runtime/helpers/esm/toPropertyKey.js
...
function prepareCssVars(theme, parserConfig) {
  ...
  const generateCssVars = (colorScheme) => {
    ...
    const css2 = _extends3({}, colorSchemesMap[colorScheme].css);
    return {
      css: css2,
...
function createCssVarsTheme(theme) {
  ...
  return _extends3({}, theme, prepareCssVars_default(otherTheme, {
    prefix: cssVarPrefix,
    shouldSkipGeneratingVar
  }));
}
...
function createContainer(options = {}) {
  ...
  const Container2 = React30.forwardRef(function Container3(inProps, ref) {
    ...
    return (
      ...
      (0, import_jsx_runtime11.jsx)(ContainerRoot, _extends3({
        as: component,
        ownerState,
...
function createGrid(options = {}) {
  ...
  const Grid2 = React31.forwardRef(function Grid3(inProps, ref) {
    ...
    let result = (0, import_jsx_runtime12.jsx)(GridRoot, _extends3({
      ref,
      as: component,
      ownerState,
      className: clsx_default(classes.root, className)
...
function createStack(options = {}) {
  ...
  const Stack2 = React32.forwardRef(function Grid2(inProps, ref) {
    ...
    return (0, import_jsx_runtime13.jsx)(StackRoot, _extends3({
      as: component,
      ownerState,
      ref,
      className: clsx_default(classes.root, className)
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EE2HID6M.js.map
